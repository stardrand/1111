...
<body>
<form class="form-horizontal" role="form" action="{{url('user/store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
        <label for="firstname" class="col-sm-2 control-label">账号</label>
        <div class="col-sm-2">
            <input type="text" class="form-control" id="firstname" name="u_name" placeholder="请输入账号">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="password" class="form-control" id="firstname" name="u_pwd" placeholder="请输入密码">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="password" class="form-control" id="firstname" name="u_pwds" placeholder="请再次输入密码">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
        <input type="text" class="form-control" id="firstname" name="u_tel" placeholder="请输入手机号">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
        <input type="text" class="form-control" id="firstname" name="u_email" placeholder="请输入邮箱">
