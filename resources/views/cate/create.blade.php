...
<form class="form-horizontal" action="{{url('/cate/store')}}" method="post" role="form">
    @csrf
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea name="cate_account" id="" cols="20" rows="6"></textarea>
        </div>
    </div>
    <div class="form-group">
...
<script>
    ...
    $('input[type=button]').click(function(){
        ...
        if(!reg.test(cate_name)){
         ...
         var res=ajaxtest($('input[name=cate_name]'),cate_name);
            if (res===1){
    ...
    $('input[name=cate_name]').blur(function(){
         ...
         var res=ajaxtest(_this,cate_name);
           if (res===1){
